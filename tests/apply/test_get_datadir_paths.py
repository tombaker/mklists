...
def test_get_datadir_paths_below_excluding_rootdir(tmp_path):
    ...
    assert get_datadir_paths_below() == expected


def test_get_datadir_paths_below_even_if_root_is_not_grandparent(tmp_path):
...
def test_get_datadir_paths_below_ignoring_hidden_directory(tmp_path):
...
def test_get_datadir_paths_below_even_if_just_one(tmp_path):
...
def test_get_datadir_paths_below_even_if_no_rulefile(tmp_path):
