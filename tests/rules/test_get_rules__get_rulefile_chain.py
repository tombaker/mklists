...
from mklists.rules import _get_rulefile_chain
from mklists.config import CONFIGFILE_NAME, ROOTDIR_RULEFILE_NAME, DATADIR_RULEFILE_NAME


def test_get_rulefile_chain_typical(tmp_path):
    ...
    assert _get_rulefile_chain(datadir=abc) == expected
    assert Path.cwd() == abc


def test_get_rulefile_chain_ends_before_repo_rootdir(tmp_path):
    ...
    assert _get_rulefile_chain() == expected


def test_get_rulefile_chain_with_specifying_rootdir(tmp_path):
...
def test_get_rulefile_chain_empty_list_when_starting_in_non_datadir(tmp_path):
...
def test_get_rulefile_chain_empty_list_when_starting_in_rootdir(tmp_path):
